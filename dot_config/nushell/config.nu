...
def --env r [] {
  ...
  let omp_init = ($autoload_dir | path join "oh-my-posh.nu")
  let zoxide_init = ($env.HOME | path join ".config" "nushell" "zoxide.nu")
  let carapace_init = ($autoload_dir | path join "carapace.nu")
  let carapace_path = (which carapace | get path.0 | path expand)
  let carapace_marker = $"# generated by ($carapace_path)\n"
